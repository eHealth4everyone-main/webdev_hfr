                ...
                <div class="form-group">
                        <div class="col-sm-3">
                                <select class="form-control select2" id="accreditation_status_id" name="accreditation_status_id" style="width: 100%;">
                                    ...
                                    <option value="{{ $st->id }}" {{ ($st->id == $data['accreditation_status_id']? "selected":"") }} >{{ $st->status }}</option>
                                    @endforeach
                                </select>
                            </div>
                        <div class="col-sm-3">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#">
                                        ...
                                        data-medical_laboratory_number="{{ $fac->medical_laboratory_number }}"  data-house_no="{{ $fac->house_no }}" data-ownership_details="{{ $fac->ownership_details }}" data-street_name="{{ $fac->street_name }}"
                                        data-laboratory_scientists="{{$fac->laboratory_scientists}}" data-laboratory_technicians="{{$fac->laboratory_technicians}}" data-quality_assurance="{{$fac->quality_assurance}}" >
                                        View
                                </button>
                            </a> 
